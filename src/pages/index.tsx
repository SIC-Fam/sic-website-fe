    ...
    <div className="h-screen">
      <LayoutDefault>
        ...
        <div className="w-full px-32 bg-transparent py-14">
          ...
          <Typography className="font-mono text-sm text-text pb-10">Sic&#39;s leaders are passionate people and have a strong long-term attachment to SIC. They always do their best for the members.</Typography>
          <Leader />
        </div>
        <div className="w-full px-32 bg-transparent py-14">
